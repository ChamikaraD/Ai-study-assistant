...
class _SummaryScreenState extends State<SummaryScreen> {
              ...
              Row(
                ...
                children: [
                  _dialogIcon(
                    ...
                    label: "Favorite",
                    onTap: () {
                      _toggleFavorite(docId, isFavorite);
                  ...
                  _dialogIcon(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => QuizScreen(summary: summary),
                        ),
                      );
                    },
                  ),
                  ...
                  _dialogIcon(
                    ...
                    label: "PDF",
                    onTap: () async {
                      await PdfService.exportSummaryToPdf(title, summary);
                    },
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("My Summaries"), centerTitle: true),
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final title = data['title'] ?? "Summary";
